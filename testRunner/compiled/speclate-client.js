...
},{"./lib/page/do-sizlate":9,"./lib/page/load-components":10,"./lib/page/loader":12,"./lib/site/app-cache":13,"./lib/site/generate-api":14,"./lib/site/generate-markup":15}],7:[function(require,module,exports){
'use strict'
...
},{"fs":5}],8:[function(require,module,exports){
(function (process){
'use strict'
...
},{"./fs":7,"_process":19}],9:[function(require,module,exports){
...
},{"sizlate":27}],10:[function(require,module,exports){
'use strict'
...
// what should this return? a string?
...
function renderComponent (component, template) {
  if (_.isString(component.data)) {
    ...
    return outArr.join('');
      ...
      console.log('log this and test it. ')
...
},{"../load-component":8,"async":17,"lodash":18,"sizlate":27}],11:[function(require,module,exports){
(function (process){
'use strict'
...
},{"../fs":7,"_process":19,"async":17,"sizlate":27}],12:[function(require,module,exports){
'use strict'
...
module.exports = function (page, callback) {
  async.parallel({
    ...
    components: function (next) {
      ...
      console.log('GOT TO HERE', err, data);
    if (err) {
      return callback(err)
    }
...
},{"./do-sizlate":9,"./load-components":10,"./load-layout":11,"async":17}],13:[function(require,module,exports){
(function (process){
'use strict'
...
},{"_process":19,"fs":5}],14:[function(require,module,exports){
(function (process){
'use strict'
...
},{"../fs":7,"./loader":16,"_process":19,"async":17}],15:[function(require,module,exports){
(function (process){
'use strict'
...
},{"../fs":7,"./loader":16,"_process":19,"async":17}],16:[function(require,module,exports){
'use strict'
...
},{"../page/loader":12,"async":17}],17:[function(require,module,exports){
...
},{"../server/dom.js":20,"./update-node":26}],24:[function(require,module,exports){
'use strict';
...
},{"./check-for-inputs":21,"./update-node-with-object":25}],27:[function(require,module,exports){
exports.render = require('./lib/do-render');
exports.classifyKeys = require('./lib/classify-keys');

},{"./lib/classify-keys":22,"./lib/do-render":23}]},{},[1]);
