...
module.exports = function (page, layout, renderedComponents) {
  ...
  for (var component in spec) {
    if (typeof spec[component].component === 'string') {
      componentSelectors[component] = renderedComponents[spec[component].component][component]
    } else {
      simpleSelectors[component] = spec[component]
    }
  }
